...
void CEFWebkitBrowserWnd::Notify(TNotifyUI& msg)
{
	if (msg.sType == DUI_MSGTYPE_CLICK)
	{
		...
		{
			pWKEWebkitCtrl_->NewPage("http://web.yy.com/city_redpackge/task.html");
		}
...
void CEFWebkitBrowserWnd::OnInitComplate()
{
	...
	{
		//pWKEWebkitCtrl_->NewPage(_T("about:blank"));
		pWKEWebkitCtrl_->NewPage(_T("http://localhost:8080"));
		//pWKEWebkitCtrl_->NewPage(_T("http://172.26.84.37:3000/task.html"));
		//pWKEWebkitCtrl_->NewPage(_T("file:///htmlexample/test.html"));
	}
